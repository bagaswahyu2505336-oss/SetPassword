...
public abstract class DashboardBase extends Application {
    ...
    // VARIABEL INI WAJIB ADA AGAR TIDAK ERROR "contentArea"
    ...
    public void start(Stage primaryStage) {
        ...
        header.getChildren().addAll(title, headerMenuContainer, spacer, logoNode);
        root.setTop(header);
    ...
    // FUNGSI INI WAJIB ADA AGAR TIDAK ERROR "tambahMenu(..., this::namaFungsi)"
    ...
    // FUNGSI INI WAJIB ADA AGAR TIDAK ERROR "buatCardKustom"
    protected Pane buatCardKustom(String judul, String nilai, String warnaBawah, String emoji) {
